...
while ! /opt/mssql-tools18/bin/sqlcmd -C -Q "SELECT 1" -b -o /dev/null
do
...
/opt/mssql-tools18/bin/sqlcmd -C -i /usr/src/app/PrepareServer.sql
...
/opt/mssql-tools18/bin/sqlcmd -C -i /usr/src/app/CreateDatabase.sql
