...
-- ------------------------------------------------------------------------------------------------------------------ --
-- changeset ${author}:Person_Obsolete_vtr stripComments:false endDelimiter:GO
-- ------------------------------------------------------------------------------------------------------------------ --
CREATE PROCEDURE Person_Obsolete_vtr
(
    @PersonNo   PersonNo,
...
END
GO
-- rollback DROP PROCEDURE Person_Obsolete_vtr;


-- ------------------------------------------------------------------------------------------------------------------ --
-- changeset ${author}:Person_Obsolete_tr stripComments:false endDelimiter:GO
-- ------------------------------------------------------------------------------------------------------------------ --
CREATE PROCEDURE Person_Obsolete_tr
(
    @PersonNo   PersonNo,
    @UpdatedDtm _CurrencyDtm
) AS
BEGIN
    ...
    EXEC Person_Obsolete_vtr @PersonNo, @UpdatedDtm;
...
END
GO
-- rollback DROP PROCEDURE Person_Obsolete_tr;
