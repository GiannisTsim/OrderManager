...
public record RetailerBranchAgentRestoreCommand
{
    ...
    public RetailerBranchAgentRestoreCommand(int? retailerNo, int? branchNo, int? agentNo, DateTimeOffset? updatedDtm)
    {
